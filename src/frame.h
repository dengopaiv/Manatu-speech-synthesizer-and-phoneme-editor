...
typedef struct {
	...
	speechPlayer_frameParam_t parallelVoiceMix; // fraction of voice signal routed to parallel formant bank (0-1, 0=noise/burst only)
	speechPlayer_frameParam_t parallelAntiFreq; // Parallel anti-resonator frequency Hz (0=disabled)
	speechPlayer_frameParam_t parallelAntiBw;   // Parallel anti-resonator bandwidth Hz
